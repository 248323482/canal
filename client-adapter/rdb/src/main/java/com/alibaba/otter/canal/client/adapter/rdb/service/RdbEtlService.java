                ...
                try {
                    ...
                    try (Connection connTarget = targetDS.getConnection();
                        ...
                        while (rs.next()) {
                            ...
                            // deleteSql.append("DELETE FROM " + SyncUtil.getDbTableName(dbMapping) + " WHERE ");
                            deleteSql.append("ALTER TABLE").append(SyncUtil.getDbTableName(dbMapping)).append(" DELETE WHERE ");
                            ...
                            for (Map.Entry<String, String> entry : columnsMap.entrySet()) {
                                ...
                                Object value = null;
                                if (srcColumnName.equals("version")) {
                                    value = RdbSyncService.sdf.format(new Date());
                                } else if (srcColumnName.equals("sign")) {
                                    value = 1;
                                }else{
